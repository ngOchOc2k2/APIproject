...
public class CreateCommentData {
	public static int n;
	@DataProvider 
	public static Object[][] CreateCommentDataProvider() throws IOException{
		String excelPath = "/home/luungoc/Downloads/TestAPI/TestAPI.xlsx";
		String sheet = "create_comment";
	...
	public static Object[][] dataRandom() throws IOException {
		String[][] data = (String[][]) CreateCommentDataProvider();
	...
	public static void main(String[] args) throws IOException {
		Object[][] x = CreateCommentDataProvider();
	}
}
