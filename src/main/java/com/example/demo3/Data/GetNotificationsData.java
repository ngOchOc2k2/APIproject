...
public class GetNotificationsData {
	@DataProvider
	public static  Object[][] GetNotificationsProvider() throws IOException{
		String excelPath = "/home/luungoc/Downloads/TestAPI/TestAPI.xlsx";
		String sheet = "GetNotifications";
	...
	public static Object[][] dataRandom() throws IOException {
		String[][] data = (String[][]) GetNotificationsProvider();
	...
	public static void main(String[] args) throws IOException {
		Object[][] x = GetNotificationsProvider();
	}
}
