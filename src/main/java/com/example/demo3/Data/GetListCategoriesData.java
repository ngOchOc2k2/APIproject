...
public class GetListCategoriesData {
	@DataProvider
	public static Object[][] GetListCategoriesDataProvider() throws IOException{
		String excelPath = "/home/luungoc/Downloads/TestAPI/TestAPI.xlsx";
		String sheet = "get_list_categories";
	...
	public static Object[][] dataRandom() throws IOException {
		String[][] data = (String[][]) GetListCategoriesDataProvider();
	...
	public static void main(String[] args) throws IOException {
		Object[][] x = GetListCategoriesDataProvider();
	}
}
