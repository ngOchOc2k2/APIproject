...
public class EditAccountData {
	@DataProvider
	public static Object[][] EditAccountDataProvider() throws IOException{
		String excelPath = "/home/luungoc/Downloads/TestAPI/TestAPI.xlsx";
		String sheet = "Edit_account";
	...
	public static Object[][] dataRandom() throws IOException {
		String[][] data = (String[][]) EditAccountDataProvider();
	...
	public static void main(String[] args) throws IOException {
		Object[][] x = EditAccountDataProvider();
	}
}
