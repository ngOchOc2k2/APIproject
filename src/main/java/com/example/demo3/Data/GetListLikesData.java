...
public class GetListLikesData {
	@DataProvider
	public static  Object[][] GetListLikesProvider() throws IOException{
		String excelPath = "/home/luungoc/Downloads/TestAPI/TestAPI.xlsx";
		String sheet = "GetListLikes";
	...
	public static Object[][] dataRandom() throws IOException {
		String[][] data = (String[][]) GetListLikesProvider();
