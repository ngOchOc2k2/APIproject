...
public class GetDetailAuctionData {
	@DataProvider
	public static Object[][] GetDetailAuctionDataProvider() throws IOException {
		String excelPath = "/home/luungoc/Downloads/TestAPI/TestAPI.xlsx";
		String sheet = "get_detail_auction";
	...
	public static Object[][] dataRandom() throws IOException {
		String[][] data = (String[][]) GetDetailAuctionDataProvider();
	...
	public static void main(String[] args) throws IOException {
		Object[][] x = GetDetailAuctionDataProvider();
	}
}
