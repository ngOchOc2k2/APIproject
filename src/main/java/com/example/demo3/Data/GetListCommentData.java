...
public class GetListCommentData {
	@DataProvider
	public static Object[][] GetListCommentDataProvider() throws IOException{
		String excelPath = "/home/luungoc/Downloads/TestAPI/TestAPI.xlsx";
		String sheet = "get_list_comments";
	...
	public static Object[][] dataRandom() throws IOException {
		String[][] data = (String[][]) GetListCommentDataProvider();
	...
	public static void main(String[] args) throws IOException {
		Object[][] x = GetListCommentDataProvider();
	}
}
