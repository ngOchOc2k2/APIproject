...
public class GetListBidsData {
	@DataProvider
	public static Object[][] GetListBidsDataProvider() throws IOException{
		String excelPath = "/home/luungoc/Downloads/TestAPI/TestAPI.xlsx";
		String sheet = "get_list_bids";
	...
	public static Object[][] dataRandom() throws IOException {
		String[][] data = (String[][]) GetListBidsDataProvider();
	...
	public static void main(String[] args) throws IOException {
		Object[][] x = GetListBidsDataProvider();
	}
}
