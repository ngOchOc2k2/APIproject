...
public class GetListAuctionsByType {
	...
	@Test(dataProvider = "GetListAuctionsByTypeDataProvider", dataProviderClass = GetListAuctionsByTypeData.class)
	public void testAll(String typeId, String index, String count, String code, String message) {
