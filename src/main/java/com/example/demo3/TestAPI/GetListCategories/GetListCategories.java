package com.example.demo3.TestAPI.GetListCategories;

import com.example.demo3.Controller.Controller;
import com.example.demo3.Data.GetListCategoriesData;
...
public class GetListCategories {
	...
	@Test(dataProvider = "GetListCategoriesDataProvider", dataProviderClass = GetListCategoriesData.class)
	public void testAll(String code, String message) {
		RequestSpecification request = RestAssured.given();
		request.baseUri(constant.GET_LIST_CATEGORIES);
