package com.example.demo3.TestAPI.Slider;

import com.example.demo3.Controller.Controller;
import com.example.demo3.Data.SliderData;
...
public class Slider {
	...
	@Test(dataProvider = "SliderDataProvider", dataProviderClass = SliderData.class)
	public void testAll(String code, String message) {
		RequestSpecification request = RestAssured.given();
		request.baseUri(constant.GET_SLIDER);
