...
public class CreateBidRandom {
	public static StringBuilder a = new StringBuilder();
	@Test(dataProvider = "dataRandom", dataProviderClass = CreateBidData.class)
	public static void testAll(String auction_id, String logged_in, String price, String last_bid_id, String code, String message) {
		...
		requestParams.put("last_bid_id", last_bid_id);
