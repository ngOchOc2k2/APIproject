...
public class CreateItemRandom {
	public static StringBuilder a = new StringBuilder();
	private static final DecimalFormat df = new DecimalFormat("0.00");
	@Test(dataProvider = "dataRandom", dataProviderClass = CreateItemData.class)
	public static void testCreateAuction(String auction_id, String logged_in, String name, String starting_price, String brand_id, String description, String series, String images, String code, String message) {
