package com.example.demo3.TestAPI.ReadNotification;

import com.example.demo3.Controller.Controller;
import com.example.demo3.Data.ReadNotificationsData;
...
public class readNotificationsAtIndex {
	public static StringBuilder a = new StringBuilder();
	@Test(dataProvider = "dataAtindex", dataProviderClass =	ReadNotificationsData.class)
	public static void testAll(String auctionId,String code,String message) {
		RequestSpecification rq = RestAssured.given();
		rq.baseUri(constant.READ_NOTIFICATION);
