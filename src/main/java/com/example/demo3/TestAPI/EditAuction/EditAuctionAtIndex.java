...
public class EditAuctionAtIndex {
	public static StringBuilder a = new StringBuilder();
	private static final DecimalFormat df = new DecimalFormat("0.00");
	@Test(dataProvider = "dataRandom", dataProviderClass = EditAuctionData.class)
	public static void testCreateAuction(String auction_id, String logged_in, String category_id, String TTS, String TTL, String title_ni, String code, String message) {
