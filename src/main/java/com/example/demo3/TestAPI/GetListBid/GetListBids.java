package com.example.demo3.TestAPI.GetListBid;

import com.example.demo3.Controller.Controller;
import com.example.demo3.Data.GetListBidsData;
...
public class GetListBids {
	...
	@Test(dataProvider = "GetListBidsDataProvider", dataProviderClass = GetListBidsData.class)
	public void testAll(String auctionId, String index, String count, String code, String message) {
		RequestSpecification request = RestAssured.given();
		request.baseUri(constant.GET_LIST_BIDS);
