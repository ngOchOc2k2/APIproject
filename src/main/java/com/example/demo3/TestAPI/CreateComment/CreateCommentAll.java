...
public class CreateCommentAll {
	public static StringBuilder a = new StringBuilder();
	@Test(dataProvider = "CreateCommentDataProvider", dataProviderClass = CreateCommentData.class)
	public void testAll(String auction_id, String logged_in, String content, String last_comment_id, String code, String message) {
