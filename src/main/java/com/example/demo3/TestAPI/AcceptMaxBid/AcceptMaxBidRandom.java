...
public class AcceptMaxBidRandom {
	public static StringBuilder a = new StringBuilder();
	@Test(dataProvider = "dataRandom", dataProviderClass = AcceptMaxBidData.class)
	public static void testAll(String auction_id, String logged_in, String selling_info, String code, String message) {
