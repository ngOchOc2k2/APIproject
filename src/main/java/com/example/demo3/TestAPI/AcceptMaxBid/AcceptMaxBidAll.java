package com.example.demo3.TestAPI.AcceptMaxBid;

import com.example.demo3.Controller.Controller;
import com.example.demo3.Data.AcceptMaxBidData;
...
public class AcceptMaxBidAll {
	public static StringBuilder a = new StringBuilder();
	@Test(dataProvider = "AcceptMaxBidDataProvider", dataProviderClass = AcceptMaxBidData.class)
	public void testAll(String auction_id, String logged_in, String selling_info, String code, String message) {
		RequestSpecification request = RestAssured.given();
		request.baseUri(constant.ACCEPT_MAX_BID);
		...
		requestParams.put("selling_info", selling_info);
